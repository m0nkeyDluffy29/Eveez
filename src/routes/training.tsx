...
export const Route = createFileRoute("/training")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Empowering the workforce that powers EVeez. Certified EV technicians, fleet operators, and trainers." },
    ],
  }),
...
function TrainingPage() {
  const tracks = [
    { I: BookOpen, t: "EV Technician", w: "12 weeks", d: "Battery, motor, controller diagnostics." },
    { I: Users,    t: "Fleet Operator", w: "6 weeks",  d: "Operations, telematics, depot management." },
    { I: Award,    t: "Trainer Certification", w: "4 weeks", d: "Train the trainers — accredited curriculum." },
  ];
  return (
    <SectionShell vertical="training">
      <div className="grid lg:grid-cols-3 gap-6">
        {tracks.map((t, i) => (
          <motion.div
            key={t.t}
            initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.08, duration: 0.6 }}
          ...
          >
            ...
            <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground">{t.w}</div>
      ...
      >
        <div className="md:col-span-1">
          ...
          <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Certified to date</div>
        </div>
