...
export const Route = createFileRoute("/vehicle-rd")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Designing the EVs of the next decade. Aerodynamics, batteries, and software co-engineered." },
    ],
  }),
  component: RDPage,
});
  ...
  return (
    <SectionShell vertical="vehicle-rd">
      <div className="grid lg:grid-cols-5 gap-6">
        ...
        >
          <div className="text-xs uppercase tracking-[0.25em] text-muted-foreground">Concept · EV-X1</div>
          <h3 className="mt-1 text-2xl font-semibold">A new silhouette of motion</h3>
          ...
          <div className="relative mt-6 aspect-[16/9] rounded-xl border border-border bg-[radial-gradient(ellipse_at_center,oklch(0.26_0.04_55_/_0.4),oklch(0.14_0.02_250))] overflow-hidden">
            <motion.div
              initial={{ x: -60, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 1.2, ease: [0.22, 1, 0.36, 1] }}
            ...
            >
              ...
              <svg viewBox="0 0 600 220" className="w-[80%]">
                ...
                <g fill="none" stroke="url(#evx)" strokeWidth="1.5" opacity="0.95">
        ...
        <div className="lg:col-span-2 grid gap-4">
          {[
            { I: Atom, t: "Modular chassis", d: "One platform, three form-factors. Shared electronics, swappable shells." },
            { I: Battery, t: "Cell-to-pack", d: "Higher density, lower weight. 2,000 cycles to 80%." },
            { I: Wind, t: "Aero-first design", d: "CFD-tuned bodywork shaving every watt-hour." },
            { I: Car, t: "Software-defined", d: "OTA updates that improve range and ride after delivery." },
          ].map((c, i) => (
            <motion.div
              key={c.t}
              initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.08, duration: 0.6 }}
